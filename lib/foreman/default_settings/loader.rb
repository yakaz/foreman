  ...
  module DefaultSettings
    module Loader
      class << self
        ...
        def set name, description, default, options = nil
          ...
          {:name => name, :value => value, :description => description, :default => default, :meta => options}
        end
        ...
        def load(reset=false)
          ...
          Setting.transaction do
            ...
            [
              ...
              set('enc_format', "What format should Foreman use to answer Puppet in its ENC yaml output? ", "puppet 0.23.0+", :enum => Host::ENC_FORMATS),
